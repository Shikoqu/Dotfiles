#!/usr/bin/env zsh
# Generated by Powerlevel10k configuration wizard on 2024-07-20 at 11:54 CEST.
...
# angled separators, round heads, blurred tails, 2 lines, disconnected, no frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=216
